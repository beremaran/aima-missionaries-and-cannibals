...
import org.cbu.cse3111.mc.environment.MCFunctions;
import org.cbu.cse3111.mc.environment.MCProblem;
...
public class MissionairesAndCanniblesDemo {
    ...
    private static void MC_UCS() {
        ...
        try {
            MCProblem problem = MCFunctions.createMCProblem();
    ...
    private static void MC_GreedyBestFirst() {
        ...
        try {
            ...
            SearchForActions search = new GreedyBestFirstSearch(new GraphSearch(), MCFunctions.getHeuristicFunction());
            SearchAgent agent = new SearchAgent(problem, search);
    ...
    private static void MC_AStar() {
        ...
        try {
            ...
            SearchForActions search = new AStarSearch(new GraphSearch(), MCFunctions.getHeuristicFunction());
            SearchAgent agent = new SearchAgent(problem, search);
